...
# Dependencies
from src.dataset import GenImgModelsDataset
...
def main(
    ...
    train_dts = GenImgModelsDataset(data_config_path=data_config,
                                    data_flag=data_flag,
                                    folder='train',
                                   )
    ...
    val_dts = GenImgModelsDataset(data_config_path=data_config,
                                  data_flag=data_flag,
                                  folder='val',
                                  transforms=None,
                                 )
